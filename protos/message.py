...
_COMMAND = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BROADCAST', index=5, number=6,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COMPLETE_ORDER', index=11, number=12,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FIND_NODE', index=12, number=13,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FIND_VALUE', index=13, number=14,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_CONTRACT', index=14, number=15,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_IMAGE', index=15, number=16,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_PROFILE', index=16, number=17,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_LISTINGS', index=17, number=18,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_USER_METADATA', index=18, number=19,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_CONTRACT_METADATA', index=19, number=20,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_FOLLOWING', index=20, number=21,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_FOLLOWERS', index=21, number=22,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DISPUTE_OPEN', index=22, number=23,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DISPUTE_CLOSE', index=23, number=24,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BAD_REQUEST', index=24, number=400,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NOT_FOUND', index=25, number=404,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CALM_DOWN', index=26, number=420,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNKNOWN_ERROR', index=27, number=520,
      options=None,
      type=None),
  ],
