...
_COMMAND = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FIND_NODE', index=9, number=10,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FIND_VALUE', index=10, number=11,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_CONTRACT', index=11, number=12,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_IMAGE', index=12, number=13,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_PROFILE', index=13, number=14,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_LISTINGS', index=14, number=15,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_USER_METADATA', index=15, number=16,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_CONTRACT_METADATA', index=16, number=17,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_FOLLOWING', index=17, number=18,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_FOLLOWERS', index=18, number=19,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BAD_REQUEST', index=19, number=400,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NOT_FOUND', index=20, number=404,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CALM_DOWN', index=21, number=420,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNKNOWN_ERROR', index=22, number=520,
      options=None,
      type=None),
  ],
