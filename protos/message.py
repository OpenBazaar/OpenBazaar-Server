...
_COMMAND = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_USER_METADATA', index=10, number=11,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_CONTRACT_METADATA', index=11, number=12,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BAD_REQUEST', index=12, number=400,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NOT_FOUND', index=13, number=404,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CALM_DOWN', index=14, number=420,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNKNOWN_ERROR', index=15, number=520,
      options=None,
      type=None),
  ],
...
GET_PROFILE = 9
GET_LISTINGS = 10
GET_USER_METADATA = 11
GET_CONTRACT_METADATA = 12
BAD_REQUEST = 400
NOT_FOUND = 404
CALM_DOWN = 420
UNKNOWN_ERROR = 520
