...
_PROFILE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='vendor', full_name='Profile.vendor', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='handle', full_name='Profile.handle', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='about', full_name='Profile.about', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='website', full_name='Profile.website', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='email', full_name='Profile.email', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='social', full_name='Profile.social', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='primary_color', full_name='Profile.primary_color', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='secondary_color', full_name='Profile.secondary_color', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='background_color', full_name='Profile.background_color', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='text_color', full_name='Profile.text_color', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='follower_count', full_name='Profile.follower_count', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='following_count', full_name='Profile.following_count', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pgp_key', full_name='Profile.pgp_key', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='avatar_hash', full_name='Profile.avatar_hash', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='header_hash', full_name='Profile.header_hash', index=15,
