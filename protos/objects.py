...
_PROFILE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='moderator_list', full_name='Profile.moderator_list', index=7,
