...
_PLAINTEXT_MESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='subject', full_name='Plaintext_Message.subject', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='type', full_name='Plaintext_Message.type', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='message', full_name='Plaintext_Message.message', index=3,
