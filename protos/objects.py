...
_FOLLOWERS_FOLLOWER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='signed_pubkey', full_name='Followers.Follower.signed_pubkey', index=1,
      number=2, type=12, cpp_type=9, label=2,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FOLLOWING = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='guids', full_name='Following.guids', index=0,
...
_PROFILE.fields_by_name['location'].enum_type = countries_pb2._COUNTRYCODE
...
_LISTINGS_LISTINGMETADATA.fields_by_name['origin'].enum_type = countries_pb2._COUNTRYCODE
_LISTINGS_LISTINGMETADATA.fields_by_name['ships_to'].enum_type = countries_pb2._COUNTRYCODE
