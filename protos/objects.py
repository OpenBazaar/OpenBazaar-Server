...
_PROFILE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='nsfw', full_name='Profile.nsfw', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='vendor', full_name='Profile.vendor', index=4,
      number=5, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='moderator', full_name='Profile.moderator', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='handle', full_name='Profile.handle', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='about', full_name='Profile.about', index=7,
...
_PLAINTEXT_MESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='signed_pubkey', full_name='Plaintext_Message.signed_pubkey', index=1,
      number=2, type=12, cpp_type=9, label=2,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='encryption_pubkey', full_name='Plaintext_Message.encryption_pubkey', index=2,
      number=3, type=12, cpp_type=9, label=2,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='subject', full_name='Plaintext_Message.subject', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='type', full_name='Plaintext_Message.type', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='message', full_name='Plaintext_Message.message', index=5,
      number=6, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='Plaintext_Message.timestamp', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='signature', full_name='Plaintext_Message.signature', index=7,
